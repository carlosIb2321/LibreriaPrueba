...
class StoragesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create storage" do
    assert_difference('Storage.count') do
      post storages_url, params: { storage: { book_id: @storage.book_id, quantity: @storage.quantity, store_id: @storage.store_id } }
    end
  ...
  test "should update storage" do
    patch storage_url(@storage), params: { storage: { book_id: @storage.book_id, quantity: @storage.quantity, store_id: @storage.store_id } }
